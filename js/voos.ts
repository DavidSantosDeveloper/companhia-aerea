...
class ItemRelatorio{
    ...
    tempoTotalDeViagens:number

    constructor(aeronave:Aeronave,quantidadeDeViagens:number,tempoTotalDeViagens:number){
...
class Relatorio{
    data_de_referencia:number
    data_emissao:number
    listaDeItemRelatorio:ItemRelatorio[]=[]

   public adicionarItemRelatorio(novo_item_do_relatorio:ItemRelatorio){
...
function somar_tempo_das_viagens_de_uma_aeronave(lista_de_voos:Voo[],aeronave:Aeronave){
...
function contar_numero_de_viagens_de_uma_aeronave(lista_de_voos:Voo[],aeronave:Aeronave){
    let  id_aeronave_buscada=aeronave.modelo+"-"+aeronave.marca
